...
public class SaveUserController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			User user2 = (User) dao.saveUser(user);
			...
			if (user2 != null) {
				...
				req.setAttribute("message", "User Alredy present with this Email");
			...
			req.setAttribute("message", "User Alredy present with this Phone Number");
			RequestDispatcher dispatcher = req.getRequestDispatcher("signup.jsp");
			dispatcher.forward(req, resp);
		}
